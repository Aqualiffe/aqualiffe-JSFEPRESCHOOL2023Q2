...
Оба слайдера работают \n


С подсчетом баллов запуталась =(
`)
...
// const modalBuyCard = document.querySelector('.modalIn');
// const btnBuyClose = document.querySelector('.x-log');
// const actBuyCard = document.querySelector('.x-log');
